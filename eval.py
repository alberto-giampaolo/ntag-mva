...
model_names = ['BDT/grid_0_extend_copy/models/066']
save_to = '/home/llr/t2k/giampaolo/srn/ntag-mva/models/BDT/grid_0_extend_copy/plots'
...
#plot_ROC(x_test,y_test,models_names_n7=zip(ntag_models,model_names), save_to=save_to, save_name='066.pdf', TMVA=True)
...
plt.savefig(save_to+'/066_hist_auc.pdf')

#print(load_hist(model_names[0])['validation_1']['auc'][-1])

bdt_importance_rank(ntag_models[0], plot_location=save_to+'/066_rank.pdf')
