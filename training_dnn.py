...
NLAYERS = 1
NNODES = 50
model_name = "NN\\epochs\\NN22_n%i_%iepoch_%ibatch_%ix%i_%i"%(N10TH, NEPOCHS,BATCH_SIZE, NLAYERS,NNODES,NFILES)
...
if __name__ == '__main__':
    ...
    ntag_history = ntag_model.fit_generator(train_gen, validation_data=test_gen,epochs=NEPOCHS,verbose=1,use_multiprocessing=True, workers=1)
    end_time = time.time()
